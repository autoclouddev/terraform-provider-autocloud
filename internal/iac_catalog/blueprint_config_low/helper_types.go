...
// These types are "borrowed" from an internal package
// because it is internal, we cant access the original ones
// the conversion to these types is made by unsafe pointers
// as they have the same bytes structure in memory, it should be no problem
// when "casting" the unkwon types to these ones
// the internal lib is the following:
//github.com/hashicorp/terraform-plugin-sdk/v2/internal/configs/configschema/schema.go
